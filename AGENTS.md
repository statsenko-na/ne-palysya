...
`Не пались` — локальная браузерная top-down pixel-art стелс-игра про Быкентия (айтишник-рокер без очков) в отделе рисковых кредитов алматинского БЦ «Угар». Начальник — Директор Начальникович (Д.Н., лысый, в очках, без усов). Игровой UI использует стилизованное название «Фирдом Банк» и эмблему без словесного логотипа.
