...
(() => {
  ...
  function drawWalls(g) {
    ...
    // Туалет в южной стене кухни: дверь, табличка WC и вечная очередь
    R(g, 114, 266, 28, 16, '#5b4a36'); R(g, 115, 267, 26, 15, '#7a6146'); R(g, 116, 268, 11, 13, '#836a4d'); R(g, 129, 268, 11, 13, '#836a4d');
    R(g, 137, 274, 2, 3, '#d8c890');
    R(g, 119, 257, 18, 8, '#2a6aa0'); T(g, 'WC', 128, 261.3, 5.6, '#fff', 'center', 700, FONT_SANS);
